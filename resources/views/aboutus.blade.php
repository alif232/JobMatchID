...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>JobMatchID | About Us</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bolder fs-2 fst-italic" href="#">
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <form class="ps-lg-5">
              <a class="btn btn-lg btn-primary rounded-pill bg-gradient order-0" href="signin">Sign In</a>
              <a class="btn btn-lg btn-secondary rounded-pill bg-gradient order-0" href="signup">Sign Up</a>
            </form>
          </div>
        </div>
      </nav>
      <section class="py-0" id="home">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(home/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-sm-none" style="background-image:url(home/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row align-items-center min-vh-75 min-vh-md-100">
            ...
            <h1 class="mt-6 mb-sm-4 display-2 fw-semi-bold lh-sm fs-4 fs-lg-6 fs-xxl-8">Selamat Datang Di <br class="d-block d-lg-none d-xl-block" />JobMatchID</h1>
                <p class="mb-4 fs-1">Membantu Anda Untuk Mencarikan Pekerjaan Yang Cocok Dengan CV Anda. Melamar Hanya Dengan 1 Website Saja</p>
              <div class="pt-3">
              </div>
            </div>
          </div>
      ...
      <section class="py-5">
        <div class="bg-holder" style="background-image:url(home/assets/img/illustrations/bg.png);background-position:left top;background-size:initial;margin-top:-180px;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-0 text-center text-md-start"><img class="img-fluid mb-4" src="home/assets/img/illustrations/passion.png" width="450" alt="" /></div>
            <div class="col-md-5 text-center text-md-start">
              <h6 class="fw-bold fs-2 fs-lg-3 display-3 lh-sm">Cari pekerjaan yang cocok dan<br />Mendapatkan kesuksesan</h6>
              <p class="my-4 pe-xl-8"> Mencari pekerjaan yang cocok dengan CV anda menggunakan bantuan fitur rekomendasi. Dengan bekerja sesuai kemampuan anda, anda dapat bekerja dengan senang hati.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-0">
        ...
        <div class="container">
          ...
          <section class="py-8">
            ...
            <div class="container">
              <div class="row flex-center">
                <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="home/assets/img/illustrations/jobs.png" width="450" alt="" /></div>
                <div class="col-md-5 text-center text-md-start">
                  <h6 class="fw-bold fs-2 fs-lg-3 display-3 lh-sm">Ada banyak pekerjaan, temukan <br> salah satu pekerjaan yang cocok dengan anda</h6>
                  <p class="my-4 pe-xl-8">Dapatkan informasi detail tentang pekerjaan dari satu aplikasi.</p>
                </div>
              </div>
            </div>
            <!-- end of .container-->
      ...
      <section class="py-5">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(home/assets/img/illustrations/category-bg.png);background-position:right top;background-size:200px 320px;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-9 col-lg-6 text-center mb-3">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Cara Melamar Di JobMatchID</h5>
              <p class="mb-5">Melamar Tanpa Aplikasi Ketiga</p>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="home/assets/img/illustrations/no1.png" height="120" alt="" />
                      <div class="card-body px-2">
                        <h6 class="fw-bold fs-1 heading-color">Buat Akun</h6>
                        <p class="mb-0 card-text">Buat akun baru di JobMatchID dan lengkapi data diri anda</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="home/assets/img/illustrations/no2.png" height="120" alt="" />
                      <div class="card-body px-2">
                        <h6 class="fw-bold fs-1 heading-color">Cari Pekerjaan</h6>
                        <p class="mb-0 card-text">Cari pekerjaan yang cocok atau gunakan fitur rekomendasi untuk mempermudah pencarian</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="home/assets/img/illustrations/no3.png" height="120" alt="" />
                      <div class="card-body px-2">
                        <h6 class="fw-bold fs-1 heading-color">Melamar Pekerjaan</h6>
                        <p class="mb-0 card-text">Submit lamaran ke perusahaan yang cocok dan tunggu informasi selanjutnya</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section class="py-8">
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="home/assets/img/illustrations/feature.png" width="450" alt="" /></div>
            <div class="col-md-5 text-center text-md-start">
      ...
      <section class="py-0"><img class="w-100" src="home/assets/img/illustrations/come-on-join.png" alt="" />
        <div class="container">
                    ...
                    <div class="row h-100 m-lg-7 mx-3 mt-6 mx-md-4 my-md-7">
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="home/assets/img/gallery/user-1.png" alt="" /></div>
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="home/assets/img/gallery/user-2.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="home/assets/img/gallery/user-3.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
      ...
      <section class="py-0 bg-primary-gradient">
        <div class="bg-holder" style="background-image:url(home/assets/img/illustrations/footer-bg.png);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
